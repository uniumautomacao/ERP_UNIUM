...
L2:
L3:Este arquivo contém a documentação resumida das tabelas do Dataverse usadas no projeto.
L4:
L5:## Índice de Entidades
L6:
...
L28:|| Solicitação de Ajuste de Estoque | `new_solicitacaodeajustedeestoque` | `new_solicitacaodeajustedeestoques` | `new_solicitacaodeajustedeestoqueid` |
...
L32:|| Preço de Produto | `new_precodeproduto` | `new_precodeprodutos` | `new_precodeprodutoid` |
...
L39:|| Comentário de Ordem de Serviço | `new_comentariodeordemdeservico` | `new_comentariodeordemdeservicos` | `new_comentariodeordemdeservicoid` |
...
L42:|| Histórico da Remessa | `new_historicoremessa` | `new_historicoremessas` | `new_historicoremessaid` |
L43|
L44|---
L45|
L46|## 🔵 new_contagemestoque (Contagem Estoque)
L47|
L48|### Informações Básicas
L49|```
...
L54|```
L55|
L56|### ⚡ Campos de Lookup (Navigation Properties)
...
L62|---
L63|
L64|## 🔵 new_contagemdodia (Contagem do Dia)
L65|
L66|### Informações Básicas
L67|```
...
L72|```
L73|
L74|### ⚡ Campos de Lookup (Navigation Properties)
...
L79|---
L80|
L81|## 🔵 new_contagemdodiaitem (Contagem do Dia Item)
L82|
L83|### Informações Básicas
L84|```
...
L89|```
L90|
L91|### ⚡ Campos de Lookup (Navigation Properties)
...
L98|---
L99|
L100|## 🔵 new_ajustedeestoque (Ajuste de Estoque)
L101|
L102|### Informações Básicas
L103|```
...
L108|```
L109|
L110|### ⚡ Campos de Lookup (Navigation Properties)
...
L117|---
L118|
L119|## 🔵 new_solicitacaodeajustedeestoque (Solicitação de Ajuste de Estoque)
L120|
L121|### Informações Básicas
L122|```
...
L127|```
L128|
L129|### ⚡ Campos de Lookup (Navigation Properties)
...
L137|---
L138|
L139|## 🔵 new_registrodeleiturademercadoriaemestoque (Registro de Leitura de Mercadoria em Estoque)
L140|
L141|### Informações Básicas
L142|```
...
L147|```
L148|
L149|### ⚡ Campos de Lookup (Navigation Properties)
...
L155|---
L156|
L157|## 🔵 new_registrodevenda (Registro de Venda)
L158|
L159|### Informações Básicas
L160|```
...
L165|```
L166|
L167|### ⚡ Campos de Lookup (Navigation Properties)
...
L176|---
L177|
L178|## 🔵 new_s3objects (S3 Objects)
L179|
L180|### Informações Básicas
L181|```
...
L186|```
L187|
L188|### ⚡ Campos de Lookup (Navigation Properties)
...
L198|---
L199|
L200|## 🔵 new_precodeproduto (Preço de Produto)
L201|
L202|### Informações Básicas
L203|```
...
L208|```
L209|
L210|### ⚡ Campos de Lookup (Navigation Properties)
...
L223|---
L224|
L225|## 🔵 cr22f_fornecedoresfromsharepointlist (Fornecedores From Sharepoint List)
L226|
L227|### Informações Básicas
L228|```
...
L233|```
L234|
L235|### Campos adicionais (Gestão de Compras) - ATUALIZADO
L236>|| AttributeLogicalName | Type | Notas |
L237>||----------------------|------|-------|
L238>|| new_prazofrete | Integer | Prazo de frete (dias) - NÃO CALCULADA |
L239>|| new_leadtimetotal | Integer | CALCULADA (soma prazo padrão + frete) |
L240|
L241|---
L242|
L243|## 🔵 new_tiposervicoprecodeproduto (TipoServiço-PreçodeProduto)
L244|
L245|### Informações Básicas
L246|```
...
L251|```
L252|
L253|### ⚡ Campos de Lookup (Navigation Properties)
...
L260|---
L261|
L262|## 🔵 new_tipodeservico (Tipo de Serviço)
L263|
L264|### Informações Básicas
L265|```
...
L270|```
L271|
L272|### ⚡ Campos de Lookup (Navigation Properties)
...
L277|---
L278|
L279|## 🔵 new_cotacaotemporariadeproduto (Cotação Temporária de Produto)
L280|
L281|### Informações Básicas
L282|```
...
L287|```
L288|
L289|### ⚡ Campos de Lookup (Navigation Properties)
...
L295|---
L296|
L297|## 🔵 new_regimedecotacaotemporaria (Regime de Cotação Temporária)
L298|
L299|### Informações Básicas
L300|```
...
L305|```
L306|
L307|### ⚡ Campos de Lookup (Navigation Properties)
...
L312|---
L313|
L314|## 🔵 new_tipodeservicoregimedecotacaotemporaria (Tipo de Serviço Regime de Cotação Temporária)
L315|
L316|### Informações Básicas
L317|```
...
L322|```
L323|
L324|### ⚡ Campos de Lookup (Navigation Properties)
...
L330|---
L331|
L332|## 🔵 contact (Contact)
L333|
L334|### Informações Básicas
L335|```
...
L342|---
L343|
L344|## 🔵 cr22f_estoquefromsharepointlist (Estoque From Sharepoint List)
L345|
L346|### Informações Básicas
L347|```
...
L352|```
L353|
L354|### ⚡ Campos Adicionais (Atualizados)
L355|*   `new_ultimacontagem`: Data da última contagem realizada.
L356|*   `new_centrodedistribuicao`: Centro de distribuição vinculado (OptionSet).
L357|*   `new_deposito`: Depósito vinculado (OptionSet).
L358|*   `new_rua`: Rua no depósito (OptionSet).
L359|*   `new_estante`: Estante no depósito (OptionSet).
L360|*   `new_prateleira`: Prateleira no depósito (OptionSet).
L361|*   `new_classecriticidade`: Classe de criticidade do produto (OptionSet).
L362|*   `new_confirmacaodeetiqueta`: Confirmação manual da etiqueta.
L363|*   `new_confirmacaodetag`: Confirmação manual da tag.
L364|*   `new_contemrma`: Indica se há RMA associado.
L365|*   `new_endereco`: Endereço completo formatado.
L366|*   `new_etiquetaemtextocalculated`: Etiqueta legível calculada.
L367|*   `new_referenciadoproduto`: Referência do produto.
L368|
L369|### ⚡ Campos de Lookup (Navigation Properties)
...
L380|---
L381|
L382|## 🔵 new_estoquerma (Estoque-RMA)
L383|
L384|### Informações Básicas
L385|```
...
L390|```
L391|
L392|### ⚡ Campos de Lookup (Navigation Properties)
...
L409|```
L410|
L411|### ⚡ Campos de Lookup (Navigation Properties)
...
L417|---
L418|
L419|## 🔵 cr22f_fabricantesfromsharpointlist (Fabricantes From Sharepoint List)
L420|
L421|### Informações Básicas
L422|```
...
L427|```
L428|
L429|### ⚡ Campos de Lookup (Navigation Properties)
...
L434|---
L435|
L436|## 🔵 cr22f_modelosdeprodutofromsharepointlist (Modelos de Produto From Sharepoint List)
L437|
L438|### Informações Básicas
L439|```
...
L444|```
L445|
L446|### ⚡ Campos de Lookup (Navigation Properties)
...
L452|---
L453|
L454|## 🔵 new_deviceio (Device IO)
L455|
L456|### Informações Básicas
L457|```
...
L462|```
L463|
L464|### ⚡ Campos de Lookup (Navigation Properties)
...
L470|---
L471|
L472|## 🔵 new_deviceioconnection (Device IO Connection)
L473|
L474|### Informações Básicas
L475|```
...
L480|```
L481|
L482|### ⚡ Campos de Lookup (Navigation Properties)
...
L489|---
L490|
L491|## 🔵 cr22f_projeto (Projeto)
L492|
L493|### Informações Básicas
L494|```
...
L499|```
L500|
L501|### ⚡ Campos de Lookup (Navigation Properties)
...
L509|---
L510|
L511|## 🔵 new_apppreference (App Preference)
L512|
L513|### Informações Básicas
L514|```
...
L519|```
L520|
L521|### ⚡ Campos de Lookup (Navigation Properties)
...
L526|---
L527|
L528|## 🔵 new_atividadefieldcontrol (Atividade Field Control)
L529|
L530|### Informações Básicas
L531|```
...
L536|```
L537|
L538|### ⚡ Campos de Lookup (Navigation Properties)
...
L545|---
L546|
L547|## 🔵 new_corcolaboradorlinhadotempo (Cor Colaborador Linha do Tempo)
L548|
L549|### Informações Básicas
L550|```
...
L555|```
L556|
L557|### ⚡ Campos de Lookup (Navigation Properties)
...
L562|---
L563|
L564|## 🔵 new_ordemdeservicofieldcontrol (Ordem de Serviço Field Control)
L565|
L566|### Informações Básicas
L567|```
...
L572|```
L573|
L574|### ⚡ Campos de Lookup (Navigation Properties)
...
L585|---
L586|
L587|## 🔵 new_remessa (Remessa)
L588|
L589|### Informações Básicas
L590|```
...
L595|```
L596|
L597|### ⚡ Campos Adicionais (Atualizados)
L598|*   `new_codigoderastreio`: Código de rastreio da remessa.
L599|*   `new_prioridade`: Prioridade (Alta/Normal/Baixa).
L600|
L601|### ⚡ Campos de Lookup (Navigation Properties)
...
L608|---
L609|
L610|## 🔵 new_produtoservico (Produto-Serviço)
L611|
L612|### Informações Básicas
L613|```
...
L618|```
L619|
L620|### Campos adicionais (Gestão de Compras) - ATUALIZADO
L621>|| AttributeLogicalName | Type | Notas |
L622>||----------------------|------|-------|
L623>|| new_datalimiteparapedido | DateOnly | CALCULADA (data limite do pedido) |
L624>|| new_diasparapedido | Integer | CALCULADA (dias até a data limite) |
L625>|| new_faixadeprazo | Picklist | CALCULADA (urgência) |
L626|
L627|### ⚡ Campos de Lookup (Navigation Properties)
...
L646|```
L647|
L648|### ⚡ Campos de Lookup (Navigation Properties)
...
L654|---
L655|
L656|## 🔵 new_transportadora (Transportadora)
L657|
L658|### Informações Básicas
L659|```
...
L666|---
L667|
L668|## 🔵 new_codeapppageallowedsecurityrole (CodeApp Page Allowed Security Role)
L669|
L670|### Informações Básicas
L671|```
...
L676|```
L677|
L678|### ⚡ Campos de Lookup (Navigation Properties)
...
L687>|| new_id | String | Identificador da página |
L688>|| new_securityrole | Lookup | Referência ao Security Role |
