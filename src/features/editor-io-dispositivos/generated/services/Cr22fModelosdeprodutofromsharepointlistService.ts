...
export class Cr22fModelosdeprodutofromsharepointlistService {
  ...
  public static async create(record: Record<string, any>): Promise<IOperationResult<any>> {
    const result = await Cr22fModelosdeprodutofromsharepointlistService.client.createRecordAsync<Record<string, any>, any>(
      Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
      record
    );
    return result;
  }
  ...
  public static async update(id: string, changedFields: Partial<Record<string, any>>): Promise<IOperationResult<any>> {
    const result = await Cr22fModelosdeprodutofromsharepointlistService.client.updateRecordAsync<Partial<Record<string, any>>, any>(
      Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
      id.toString(),
      changedFields
    );
  ...
  public static async delete(id: string): Promise<void> {
    await Cr22fModelosdeprodutofromsharepointlistService.client.deleteRecordAsync(
      Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
      id.toString());
  }

  public static async get(id: string, options?: IGetOptions): Promise<IOperationResult<any>> {
    const result = await Cr22fModelosdeprodutofromsharepointlistService.client.retrieveRecordAsync<any>(
      Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
      id.toString(),
      options
    );
  ...
  public static async getAll(options?: IGetAllOptions): Promise<IOperationResult<any[]>> {
    const result = await Cr22fModelosdeprodutofromsharepointlistService.client.retrieveMultipleRecordsAsync<any>(
      Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
      options
    );
    return result;
  ...
  public static getMetadata(
    ...
    return Cr22fModelosdeprodutofromsharepointlistService.client.executeAsync({
      dataverseRequest: {
        ...
        parameters: {
          tableName: Cr22fModelosdeprodutofromsharepointlistService.dataSourceName,
